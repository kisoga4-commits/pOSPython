...
- ให้รัน **`python app.py`** (แนะนำ)
- หรือรัน **`python lock.py`** (รองรับเพื่อความเข้ากันได้เดิม)
...
## โครงสร้างสำคัญ
- `app.py` = entrypoint หลัก + Flask routes/API
- `lock.py` = entrypoint สำรอง (เรียกไปที่ `app.py`)
